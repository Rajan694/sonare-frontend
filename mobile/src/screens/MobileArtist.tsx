...
<View className="scr col" style="width:390px;height:844px">
  <View className="row between none" style="height:64px;padding:0 20px;gap:10px"><Pressable className="ib none" href="M06-Album.html" aria-label="Back"><Image source={require('../../assets/icon_32.svg')} className="ic" /></Pressable>
  ...
  <View className="col grow" style="overflow:hidden"><View className="col" style="position:relative">
      ...
      <View className="col center" style="position:relative;padding:6px 20px 0;gap:12px">
        ...
        <View className="row g10">
          ...
          <Pressable className="ib ib-40 ib-bord" aria-label="Shuffle"><Image source={require('../../assets/shuffle_6.svg')} className="ic" /></Pressable>
          <Pressable className="playbtn playbtn-48" aria-label="Play artist"><Image source={require('../../assets/play_3.svg')} className="ic" /></Pressable>
        </View>
      </View>
    ...
    <View className="col g2" style="margin:0 -8px">
      ...
      <Pressable className="ib ib-32 none" aria-label="More options for Cartographer"><Image source={require('../../assets/icon_20.svg')} className="ic" /></Pressable>
        ...
        <View className="col" style="gap:10px">
    <View className="shead"><Text className="t-h2 c1">Albums</Text><Pressable className="row g2 t-ll c2 none" href="#" style="text-decoration:none">All<Image source={require('../../assets/chevron_right.svg')} className="ic" /></Pressable></View>
