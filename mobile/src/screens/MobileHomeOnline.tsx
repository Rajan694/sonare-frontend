...
<View className="scr col" style="width:390px;height:844px">
  <View className="row between none" style="height:64px;padding:0 20px;gap:10px"><Text className="seg">
      <Pressable className="seg-i seg-on-cloud" href="M01-Home-Online.html" aria-current="true"><Image source={require('../../assets/cloud_5.svg')} className="ic" />Online</Pressable>
      <Pressable className="seg-i " href="M02-Home-Offline.html" aria-current="false"><Image source={require('../../assets/smartphone_7.svg')} className="ic" />Offline</Pressable>
    </Text>
      <Text className="row g4 none">
        <Pressable className="ib" href="M03-Search-Online.html" aria-label="Search"><Image source={require('../../assets/icon_83.svg')} className="ic" /></Pressable>
        <Pressable className="ib" href="M15-Settings.html" aria-label="Settings"><Image source={require('../../assets/icon_47.svg')} className="ic" /></Pressable>
  ...
  <View className="col grow" style="overflow:hidden"><View className="col" style="padding:4px 20px 0;gap:22px">
    ...
    <View className="grid" style="grid-template-columns:repeat(2,minmax(0,1fr));gap:10px">
      ...
      <View className="col" style="gap:12px">
    <View className="shead"><Text className="t-h2 c1">Made for you</Text><Pressable className="row g2 t-ll c2 none" href="M05-Library.html" style="text-decoration:none">All<Image source={require('../../assets/chevron_right.svg')} className="ic" /></Pressable></View>
    <View className="scrollx g12" style="margin:0 -20px;padding:0 20px"><Pressable className="acard" style="width:132px" href="M06-Album.html">
      ...
      <View className="col" style="gap:12px">
    <View className="shead"><Text className="t-h2 c1">Trending now</Text><Pressable className="row g2 t-ll c2 none" href="M03-Search-Online.html" style="text-decoration:none">All<Image source={require('../../assets/chevron_right.svg')} className="ic" /></Pressable></View>
    <View className="col g2">
      ...
      <Text className="col grow" style="gap:2px">
        <Text className="row g6"><Text className="t-tm c1 trunc">Low Orbit</Text><Text className="src src-cloud" title="Streaming from server"><Image source={require('../../assets/cloud.svg')} className="ic" /></Text></Text>
        <Text className="t-bs c2 trunc">Sundial Theory · Parallax</Text>
      </Text>
      
      <Text className="t-mono-s c3 none">6:02</Text>
      <Pressable className="ib ib-32 none" aria-label="More options for Low Orbit"><Image source={require('../../assets/icon_20.svg')} className="ic" /></Pressable>
    </View><View className="srow">
      <Text className="srow-idx">3</Text><View className="art a10 art-r-sm" style="width:44px;height:44px;"></View>
      <Text className="col grow" style="gap:2px">
        <Text className="row g6"><Text className="t-tm c1 trunc">Velvet Static</Text><Text className="src src-cloud" title="Streaming from server"><Image source={require('../../assets/cloud.svg')} className="ic" /></Text></Text>
        <Text className="t-bs c2 trunc">Mira Sound · Velvet Static</Text>
      </Text>
      
      <Text className="t-mono-s c3 none">3:51</Text>
      <Pressable className="ib ib-32 none" aria-label="More options for Velvet Static"><Image source={require('../../assets/icon_20.svg')} className="ic" /></Pressable>
    </View>
      </View></View>
    </View></View>
