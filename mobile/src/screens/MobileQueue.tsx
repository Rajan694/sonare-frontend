...
<View className="scr col" style="width:390px;height:844px">
  ...
  <View className="col grow" style="position:relative;padding:14px 20px 0">
    <View className="row between none" style="height:44px">
      ...
      <Pressable className="ib none" aria-label="Queue options"><Image source={require('../../assets/icon_95.svg')} className="ic" /></Pressable>
    </View>
    ...
    <View className="row g8 none" style="margin:8px 0 18px">
      ...
      <Pressable className="ib ib-32 none" aria-label="Shuffle queue"><Image source={require('../../assets/shuffle_4.svg')} className="ic" /></Pressable>
      <Pressable className="ib ib-32 none" aria-label="Repeat"><Image source={require('../../assets/repeat_2.svg')} className="ic" /></Pressable>
    </View>
    ...
    <View className="srow srow-on none" style="margin:0 -8px">
      ...
      <Pressable className="ib ib-32 none" aria-label="Pause"><Image source={require('../../assets/icon_69.svg')} className="ic" /></Pressable>
    </View>
    ...
    <View className="col g2" style="margin:0 -8px;overflow:hidden">
      ...
      <Pressable className="ib ib-32 none" aria-label="Remove from queue"><Image source={require('../../assets/icon_14.svg')} className="ic" /></Pressable>
                <Pressable className="ib ib-32 none drag" aria-label="Reorder Copper Wires"><Image source={require('../../assets/icon_70.svg')} className="ic" /></Pressable>
      ...
      <Pressable className="ib ib-32 none" aria-label="Remove from queue"><Image source={require('../../assets/icon_14.svg')} className="ic" /></Pressable>
                <Pressable className="ib ib-32 none drag" aria-label="Reorder Glass Houses"><Image source={require('../../assets/icon_70.svg')} className="ic" /></Pressable>
    </View><View className="srow">
      ...
      <Pressable className="ib ib-32 none" aria-label="Remove from queue"><Image source={require('../../assets/icon_14.svg')} className="ic" /></Pressable>
                <Pressable className="ib ib-32 none drag" aria-label="Reorder Half-Light"><Image source={require('../../assets/icon_70.svg')} className="ic" /></Pressable>
    </View>
