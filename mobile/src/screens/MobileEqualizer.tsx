...
<View className="scr col" style="width:390px;height:844px">
  <View className="row between none" style="height:64px;padding:0 20px;gap:10px"><Pressable className="ib none" href="M10-Now-Playing-Offline.html" aria-label="Back"><Image source={require('../../assets/icon_32.svg')} className="ic" /></Pressable>
  ...
  <View className="col grow" style="overflow:hidden"><View className="col" style="padding:0 20px;gap:18px">
      ...
      <View className="surf col" style="padding:6px 0">
        <View className="lrow"><Text className="icobox"><Image source={require('../../assets/sync_3.svg')} className="ic" /></Text>
            ...
            <Pressable className="sw on none" aria-label="Crossfade"><i></i></Pressable></View><View className="lrow"><Text className="icobox"><Image source={require('../../assets/music_2.svg')} className="ic" /></Text>
            ...
            <Pressable className="sw on none" aria-label="Gapless playback"><i></i></Pressable></View><View className="lrow"><Text className="icobox"><Image source={require('../../assets/volume.svg')} className="ic" /></Text>
