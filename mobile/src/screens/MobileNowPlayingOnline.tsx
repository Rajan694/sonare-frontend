...
<View className="scr col" style="width:390px;height:844px">
  ...
  <View className="col grow" style="position:relative;padding:14px 22px 0">
    <View className="row between none" style="height:44px">
      <Pressable className="ib none" href="M01-Home-Online.html" aria-label="Collapse player"><Image source={require('../../assets/icon_18.svg')} className="ic" /></Pressable>
    ...
    <View className="row between none" style="margin-top:14px">
      <Pressable className="ib ib-44" aria-label="Shuffle"><Image source={require('../../assets/shuffle_5.svg')} className="ic" /></Pressable>
      <Pressable className="ib ib-44" aria-label="Previous track"><Image source={require('../../assets/icon_46.svg')} className="ic" /></Pressable>
      <Pressable className="playbtn" aria-label="Pause" style="background:var(--acc);box-shadow:var(--glow-s)"><Image source={require('../../assets/icon_87.svg')} className="ic" /></Pressable>
  ...
  <View className="row g10 none" style="position:relative;margin:0 22px 22px;padding:10px 12px;background:rgba(17,17,20,.86);border:1px solid var(--ln2);border-radius:14px">
    <Text className="icobox" style="width:30px;height:30px;background:transparent;color:var(--acc)"><Image source={require('../../assets/icon_35.svg')} className="ic" /></Text>
