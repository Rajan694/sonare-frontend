...
<View className="scr col" style="width:390px;height:844px">
  ...
  <View className="col grow" style="overflow:hidden"><View className="col" style="gap:0">
      ...
      <View className="row between" style="padding:12px 20px 8px">
        <Pressable className="chip chip-sm"><Image source={require('../../assets/icon_12231e72.svg')} className="ic" />Recently added<Image source={require('../../assets/icon_42a194d5.svg')} className="ic" /></Pressable>
        <Text className="row g4">
          <Pressable className="ib ib-32" aria-label="Filter"><Image source={require('../../assets/icon_2e7a9fa1.svg')} className="ic" /></Pressable>
          <Pressable className="ib ib-32 ib-on" aria-label="List view"><Image source={require('../../assets/icon_0fe386b7.svg')} className="ic" /></Pressable>
          <Pressable className="ib ib-32" aria-label="Grid view"><Image source={require('../../assets/icon_6238c5e1.svg')} className="ic" /></Pressable>
        </Text>
      </View>
      <View className="row g10" style="padding:0 20px 10px">
        <Pressable className="btn btn-sm btn-acc" href="M10-Now-Playing-Offline.html"><Image source={require('../../assets/icon_d0e8573a.svg')} className="ic" />Play all</Pressable>
        <Pressable className="btn btn-sm btn-out"><Image source={require('../../assets/icon_e86e5a1c.svg')} className="ic" />Shuffle</Pressable>
      ...
      <Pressable className="ib ib-32 none" aria-label="More options for Ferrous"><Image source={require('../../assets/icon_58f52c4d.svg')} className="ic" /></Pressable>
    </View><View className="srow">
      ...
      <Pressable className="ib ib-32 none" aria-label="More options for Half-Light"><Image source={require('../../assets/icon_58f52c4d.svg')} className="ic" /></Pressable>
    </View><View className="srow">
      <View className="art a3 art-r-sm" style="width:44px;height:44px;"></View>
      <Text className="col grow" style="gap:2px">
