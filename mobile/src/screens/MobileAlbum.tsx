...
<View className="scr col" style="width:390px;height:844px">
  <View className="row between none" style="height:64px;padding:0 20px;gap:10px"><Pressable className="ib none" href="M05-Library.html" aria-label="Back"><Image source={require('../../assets/icon_d5a96b1c.svg')} className="ic" /></Pressable>
  ...
  <View className="col grow" style="overflow:hidden"><View className="col" style="position:relative">
      ...
      <View className="col center" style="position:relative;padding:8px 20px 0;gap:14px">
        ...
        <View className="row g10"><Text className="badge bg-local"><Image source={require('../../assets/icon_1af5e907.svg')} className="ic" />On device</Text><Text className="badge bg-neutral">FLAC · 1411 kbps</Text></View>
        <View className="row between" style="width:100%;padding-top:2px">
          <Text className="row g4">
            <Pressable className="ib ib-44" aria-label="Favourite album"><Image source={require('../../assets/icon_89f6e4d2.svg')} className="ic" /></Pressable>
            <Pressable className="ib ib-44" aria-label="Downloaded"><Image source={require('../../assets/icon_2c1f60c8.svg')} className="ic" /></Pressable>
            <Pressable className="ib ib-44" aria-label="Add to queue"><Image source={require('../../assets/icon_298d752b.svg')} className="ic" /></Pressable>
          </Text>
          <Text className="row g10">
            <Pressable className="ib ib-44 ib-bord" aria-label="Shuffle"><Image source={require('../../assets/icon_b159c94b.svg')} className="ic" /></Pressable>
            <Pressable className="playbtn playbtn-56" aria-label="Play album"><Image source={require('../../assets/icon_aebd739c.svg')} className="ic" /></Pressable>
          </Text>
        </View>
      </View>
      ...
      <Pressable className="ib ib-32 none" aria-label="More options for Cartographer"><Image source={require('../../assets/icon_58f52c4d.svg')} className="ic" /></Pressable>
        ...
        <View className="srow"><Text className="srow-idx">4</Text>
          <Text className="col grow" style="gap:2px"><Text className="row g6"><Text className="t-tm c1 trunc">Tin Roof Morning</Text><Text className="src src-local" title="On this device"><Image source={require('../../assets/icon_00df50b5.svg')} className="ic" /></Text></Text>
          <Text className="t-bs c2 trunc">Hollow Coast</Text></Text>
          <Text className="t-mono-s c3 none">4:02</Text>
          <Pressable className="ib ib-32 none" aria-label="More options"><Image source={require('../../assets/icon_58f52c4d.svg')} className="ic" /></Pressable></View><View className="srow"><Text className="srow-idx">5</Text>
          <Text className="col grow" style="gap:2px"><Text className="row g6"><Text className="t-tm c1 trunc">North Field</Text><Text className="src src-local" title="On this device"><Image source={require('../../assets/icon_00df50b5.svg')} className="ic" /></Text></Text>
          <Text className="t-bs c2 trunc">Hollow Coast</Text></Text>
          <Text className="t-mono-s c3 none">3:29</Text>
          <Pressable className="ib ib-32 none" aria-label="More options"><Image source={require('../../assets/icon_58f52c4d.svg')} className="ic" /></Pressable></View><View className="srow"><Text className="srow-idx">6</Text>
          <Text className="col grow" style="gap:2px"><Text className="row g6"><Text className="t-tm c1 trunc">Signal Hill</Text><Text className="src src-local" title="On this device"><Image source={require('../../assets/icon_00df50b5.svg')} className="ic" /></Text></Text>
          <Text className="t-bs c2 trunc">Hollow Coast</Text></Text>
          <Text className="t-mono-s c3 none">5:11</Text>
          <Pressable className="ib ib-32 none" aria-label="More options"><Image source={require('../../assets/icon_58f52c4d.svg')} className="ic" /></Pressable></View>
      </View>
    </View></View>
