...
<View className="scr col" style="width:390px;height:844px">
  <View className="row between none" style="height:64px;padding:0 20px;gap:10px"><Pressable className="ib none" href="M05-Library.html" aria-label="Back"><Image source={require('../../assets/icon_d5a96b1c.svg')} className="ic" /></Pressable>
      ...
      <Text className="row g2 none">
        <Pressable className="ib" aria-label="Edit playlist"><Image source={require('../../assets/icon_28213f10.svg')} className="ic" /></Pressable>
        <Pressable className="ib" aria-label="More options"><Image source={require('../../assets/icon_4eb1b58e.svg')} className="ic" /></Pressable>
      </Text></View>
  <View className="col grow" style="overflow:hidden"><View className="col" style="position:relative">
      ...
      <View className="rowt g16" style="position:relative;padding:8px 20px 0">
        ...
        <View className="col grow" style="gap:8px">
          ...
          <View className="row g6 wrap"><Text className="badge bg-local"><Image source={require('../../assets/icon_1af5e907.svg')} className="ic" />On device</Text><Text className="badge bg-dl"><Image source={require('../../assets/icon_b0d41f9d.svg')} className="ic" />Synced</Text></View>
        </View>
      </View>
      <View className="row between" style="padding:18px 20px 0">
        <Text className="row g4">
          <Pressable className="ib ib-44" aria-label="Favourite playlist"><Image source={require('../../assets/icon_dd993d79.svg')} className="ic" /></Pressable>
          <Pressable className="ib ib-44" aria-label="Download playlist"><Image source={require('../../assets/icon_2a9434e3.svg')} className="ic" /></Pressable>
          <Pressable className="ib ib-44" aria-label="Share playlist"><Image source={require('../../assets/icon_af31d3fe.svg')} className="ic" /></Pressable>
        </Text>
        <Text className="row g10">
          ...
          <Pressable className="playbtn playbtn-56" aria-label="Play playlist"><Image source={require('../../assets/icon_aebd739c.svg')} className="ic" /></Pressable>
        </Text>
      </View>
      <View className="row between" style="padding:16px 20px 6px">
        <Pressable className="chip chip-sm"><Image source={require('../../assets/icon_12231e72.svg')} className="ic" />Custom order<Image source={require('../../assets/icon_42a194d5.svg')} className="ic" /></Pressable>
      ...
      <Text className="t-mono-s c3 none">3:42</Text>
            <Pressable className="ib ib-32 none drag" aria-label="Reorder Paper Lanterns"><Image source={require('../../assets/icon_cd19da42.svg')} className="ic" /></Pressable>
      ...
      <Text className="col grow" style="gap:2px">
        <Text className="row g6"><Text className="t-tm c1 trunc">Undertow</Text><Text className="src src-cloud" title="Streaming from server"><Image source={require('../../assets/icon_50979100.svg')} className="ic" /></Text></Text>
        <Text className="t-bs c2 trunc">Mara Vel · Salt &amp; Signal</Text>
      </Text>
      <Text className="t-mono-s c3 none">3:27</Text>
            <Pressable className="ib ib-32 none drag" aria-label="Reorder Undertow"><Image source={require('../../assets/icon_cd19da42.svg')} className="ic" /></Pressable>
    </View><View className="srow">
