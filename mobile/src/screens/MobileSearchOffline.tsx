...
<View className="scr col" style="width:390px;height:844px">
  ...
  <View className="col grow" style="overflow:hidden"><View className="col" style="padding:0 20px;gap:16px">
    ...
    <View className="col g2"><View className="srow">
      ...
      <View className="col" style="gap:10px">
    <View className="shead"><Text className="t-h2 c1">Folders</Text><Pressable className="row g2 t-ll c2 none" href="M16-Folders.html" style="text-decoration:none">All<Image source={require('../../assets/chevron_right.svg')} className="ic" /></Pressable></View>
    <View className="col g2">
        <Pressable className="srow" href="M16-Folders.html" style="text-decoration:none;color:inherit">
          ...
          <Text className="t-bs c2">842 songs · 6.1 GB</Text></Text><Image source={require('../../assets/chevron_right_2.svg')} className="ic" /></Pressable><Pressable className="srow" href="M16-Folders.html" style="text-decoration:none;color:inherit">
          <Text className="icobox icobox-gold"><Image source={require('../../assets/folder.svg')} className="ic" /></Text>
