...
<View className="scr col" style="width:390px;height:844px">
  <View className="row between none" style="height:64px;padding:0 20px;gap:10px"><Text className="seg">
      ...
      <Text className="row g4 none">
        <Pressable className="ib" href="M04-Search-Offline.html" aria-label="Search this device"><Image source={require('../../assets/icon_83.svg')} className="ic" /></Pressable>
        <Pressable className="ib" href="M16-Folders.html" aria-label="Music folders"><Image source={require('../../assets/folder_3.svg')} className="ic" /></Pressable>
  ...
  <View className="col grow" style="overflow:hidden"><View className="col" style="padding:4px 20px 0;gap:22px">
      ...
      <Pressable className="surf row g14" style="padding:12px;text-decoration:none;color:inherit" href="M10-Now-Playing-Offline.html">
        ...
        <Text className="playbtn-fab" style="background:var(--gold);box-shadow:var(--glow-g)"><Image source={require('../../assets/play_2.svg')} className="ic" /></Text>
      </Pressable>
    ...
    <View className="col g2">
      ...
      <View className="col" style="gap:12px">
    <View className="shead"><Text className="t-h2 c1">Albums on device</Text><Pressable className="row g2 t-ll c2 none" href="M05-Library.html" style="text-decoration:none">All<Image source={require('../../assets/chevron_right.svg')} className="ic" /></Pressable></View>
    <View className="scrollx g12" style="margin:0 -20px;padding:0 20px"><Pressable className="acard" style="width:132px" href="M06-Album.html">
      ...
      <View className="col" style="gap:12px">
    <View className="shead"><Text className="t-h2 c1">Your folders</Text><Pressable className="row g2 t-ll c2 none" href="M16-Folders.html" style="text-decoration:none">All<Image source={require('../../assets/chevron_right.svg')} className="ic" /></Pressable></View>
