...
<div className="col gap-[28px]" style={{'padding': '26px 32px 0'}}>
      <div className="flex flex-row items-center justify-between">
        ...
        <div className="flex flex-row items-center gap-[10px]">
          <a className="btn btn-out" href="D16-Folders.html"><img src="/assets/folder_2.svg" className="ic" alt="icon" />Manage folders</a>
          <button className="btn btn-out"><img src="/assets/shuffle_2.svg" className="ic" alt="icon" />Shuffle all</button>
          <a className="btn btn-gold" href="D10-Now-Playing-Offline.html"><img src="/assets/play_4.svg" className="ic" alt="icon" />Play all</a>
        </div>
      </div>
      <div className="flex flex-col gap-[14px]">
        <div className="tabs">
          ...
          <button className="chip chip-sm"><img src="/assets/icon_83.svg" className="ic" alt="icon" />Recently added<img src="/assets/icon_92.svg" className="ic" alt="icon" /></button>
          <span className="flex flex-row items-center gap-[2px] ml-[8px]">
            <button className="ib ib-28 ib-on" aria-label="List view"><img src="/assets/icon_4.svg" className="ic" alt="icon" /></button>
            <button className="ib ib-28" aria-label="Grid view"><img src="/assets/icon_97.svg" className="ic" alt="icon" /></button>
          </span>
        </div>
    ...
    <span className="flex flex-row items-center gap-[2px] justify-end">
      <button className="ib ib-28" aria-label="Favourite Sodium Lamps"><img src="/assets/icon_94.svg" className="ic" alt="icon" /></button>
      <button className="ib ib-28" aria-label="More options"><img src="/assets/icon_55.svg" className="ic" alt="icon" /></button>
    </span>
  </div></div>
      </div>
    ...
    <div className="menu col absolute" style={{'left': '640px', 'top': '472px'}}>
      <span className="mi"><img src="/assets/play.svg" className="ic" alt="icon" />Play<span className="flex-grow min-w-0"></span><span className="kbd">Enter</span></span>
      <span className="mi"><img src="/assets/playlist_add.svg" className="ic" alt="icon" />Play next<span className="flex-grow min-w-0"></span><span className="kbd">Ctrl ↵</span></span>
      <span className="mi"><img src="/assets/icon_89.svg" className="ic" alt="icon" />Add to queue</span>
      <span className="mi"><img src="/assets/plus.svg" className="ic" alt="icon" />Add to playlist<img src="/assets/chevron_right.svg" className="ic" alt="icon" /></span>
      <span className="hr" style={{'margin': '5px 8px'}}></span>
      <span className="mi"><img src="/assets/icon_69.svg" className="ic" alt="icon" />Add to favourites<span className="flex-grow min-w-0"></span><span className="kbd">L</span></span>
      <span className="mi"><img src="/assets/icon_22.svg" className="ic" alt="icon" />Edit tags</span>
      <span className="mi"><img src="/assets/folder_4.svg" className="ic" alt="icon" />Show in folder</span>
      <span className="hr" style={{'margin': '5px 8px'}}></span>
      <span className="mi dis"><img src="/assets/cloud.svg" className="ic" alt="icon" />Share link<span className="flex-grow min-w-0"></span><span className="text-[11px] leading-[14px] font-medium tracking-[0.4px]">Offline</span></span>
      <span className="mi danger"><img src="/assets/icon_5.svg" className="ic" alt="icon" />Delete from device</span>
    </div></DesktopLayout>
    </>
  );
}