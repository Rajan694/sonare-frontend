      ...
      <div className="col relative gap-[24px]" style={{'padding': '32px 32px 0'}}>
        <div className="flex flex-row items-center gap-[28px] items-end">
          ...
          <div className="flex flex-col flex-grow min-w-0 gap-[12px]">
            ...
            <div className="flex flex-row items-center gap-[8px]"><span className="badge bg-local"><img src="/assets/smartphone_5.svg" className="ic" alt="icon" />On device</span><span className="badge bg-dl"><img src="/assets/sync_4.svg" className="ic" alt="icon" />Synced to account</span><span className="badge bg-neutral">38 of 42 downloaded</span></div>
            <div className="flex flex-row items-center gap-[12px] mt-[6px]">
              <button className="playbtn playbtn-56" aria-label="Play playlist"><img src="/assets/play_3.svg" className="ic" alt="icon" /></button>
              <button className="btn btn-out btn-lg"><img src="/assets/shuffle_3.svg" className="ic" alt="icon" />Shuffle</button>
              <button className="ib ib-44 ib-bord" aria-label="Favourite"><img src="/assets/heart.svg" className="ic" alt="icon" /></button>
              <button className="ib ib-44 ib-bord" aria-label="Download all"><img src="/assets/download_2.svg" className="ic" alt="icon" /></button>
              <button className="ib ib-44 ib-bord" aria-label="Edit playlist"><img src="/assets/icon_134.svg" className="ic" alt="icon" /></button>
    ...
    <span className="text-[11px] leading-[14px] font-medium tracking-[0.4px] text-t3 text-right"><img src="/assets/icon_3.svg" className="ic" alt="icon" /></span><span></span></div>
          <div className="grid srow-on gap-[16px] items-center rounded-[10px]" style={{'gridTemplateColumns': '30px 44px minmax(0,2.4fr) minmax(0,1.7fr) 116px 64px 58px 78px', 'padding': '7px 12px'}}>
            ...
            <span className="flex flex-row items-center gap-[2px] justify-end">
              ...
              <button className="ib ib-28" aria-label="Remove from playlist"><img src="/assets/icon_68.svg" className="ic" alt="icon" /></button></span>
            ...
            <span className="srow-idx drag w-[auto]"><img src="/assets/icon_130.svg" className="ic" alt="icon" /></span>
            ...
            <span className="text-[14px] leading-[20px] font-normal text-t2 truncate">Neon Arboretum</span><span className="badge bg-cloud"><img src="/assets/cloud_6.svg" className="ic" alt="icon" />Server</span>
            ...
            <span className="text-[14px] leading-[20px] font-normal text-t2 truncate">Slow Frequencies</span><span className="badge bg-local"><img src="/assets/smartphone_5.svg" className="ic" alt="icon" />On device</span>
            ...
            <span className="text-[14px] leading-[20px] font-normal text-t2 truncate">Salt &amp; Signal</span><span className="badge bg-cloud"><img src="/assets/cloud_6.svg" className="ic" alt="icon" />Server</span>
            ...
            <span className="text-[14px] leading-[20px] font-normal text-t2 truncate">Tidal Drift</span><span className="badge bg-local"><img src="/assets/smartphone_5.svg" className="ic" alt="icon" />On device</span>
            ...
            <span className="text-[14px] leading-[20px] font-normal text-t2 truncate">Quiet Riot Act</span><span className="badge bg-local"><img src="/assets/smartphone_5.svg" className="ic" alt="icon" />On device</span>
