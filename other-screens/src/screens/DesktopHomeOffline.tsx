...
<div className="col gap-[28px]" style={{'padding': '26px 32px 0'}}>
      <div className="flex flex-row items-center justify-between">
        ...
        <div className="flex flex-row items-center gap-[10px]">
          <a className="btn btn-out" href="D16-Folders.html"><img src="/assets/icon_50.svg" className="ic" alt="icon" />Scan folders</a>
          <a className="btn btn-gold" href="D10-Now-Playing-Offline.html"><img src="/assets/play_4.svg" className="ic" alt="icon" />Resume</a>
        </div>
      </div>
      ...
      <div className="offstrip"><img src="/assets/icon_40.svg" className="ic" alt="icon" />
        ...
        <a className="btn btn-sm btn-out flex-none" href="D01-Home-Online.html"><img src="/assets/cloud_3.svg" className="ic" alt="icon" />Go online</a>
      </div>
      ...
      <div className="grid gap-[12px]" style={{'gridTemplateColumns': 'repeat(3,minmax(0,1fr))'}}>
        <a className="tile h-[64px] p-[10px] pr-[16px]" href="D06-Album.html">
          ...
          <span className="playbtn-fab none w-[34px] h-[34px]" style={{'background': 'var(--gold)', 'boxShadow': 'var(--glow-g)'}}><img src="/assets/play.svg" className="ic" alt="icon" /></span></a><a className="tile h-[64px] p-[10px] pr-[16px]" href="D06-Album.html">
          <div className="art a1 art-r-sm art-rings w-[44px] h-[44px]"></div>
          <span className="flex flex-col flex-grow min-w-0 gap-[2px] min-w-[0]">
            <span className="flex flex-row items-center gap-[6px]"><span className="text-[15px] leading-[22px] font-medium text-t1 truncate">Copper Wires</span><span className="src src-local" title="On this device"><img src="/assets/smartphone_3.svg" className="ic" alt="icon" /></span></span>
            <span className="text-[13px] leading-[18px] font-normal text-t3 truncate">Hollow Coast</span></span>
          <span className="playbtn-fab none w-[34px] h-[34px]" style={{'background': 'var(--gold)', 'boxShadow': 'var(--glow-g)'}}><img src="/assets/play.svg" className="ic" alt="icon" /></span></a><a className="tile h-[64px] p-[10px] pr-[16px]" href="D06-Album.html">
          ...
          <div className="art a3 art-r-sm art-rings w-[44px] h-[44px]"></div>
          <span className="flex flex-col flex-grow min-w-0 gap-[2px] min-w-[0]">
            <span className="flex flex-row items-center gap-[6px]"><span className="text-[15px] leading-[22px] font-medium text-t1 truncate">Cassette Sunday</span><span className="src src-local" title="On this device"><img src="/assets/smartphone_3.svg" className="ic" alt="icon" /></span></span>
            <span className="text-[13px] leading-[18px] font-normal text-t3 truncate">The Orchard Machine</span></span>
          <span className="playbtn-fab none w-[34px] h-[34px]" style={{'background': 'var(--gold)', 'boxShadow': 'var(--glow-g)'}}><img src="/assets/play.svg" className="ic" alt="icon" /></span></a><a className="tile h-[64px] p-[10px] pr-[16px]" href="D06-Album.html">
          ...
          <span className="flex flex-col flex-grow min-w-0 gap-[2px] min-w-[0]">
            <span className="flex flex-row items-center gap-[6px]"><span className="text-[15px] leading-[22px] font-medium text-t1 truncate">Ferrous</span><span className="src src-local" title="On this device"><img src="/assets/smartphone_3.svg" className="ic" alt="icon" /></span></span>
            <span className="text-[13px] leading-[18px] font-normal text-t3 truncate">Kite &amp; Anchor</span></span>
          <span className="playbtn-fab none w-[34px] h-[34px]" style={{'background': 'var(--gold)', 'boxShadow': 'var(--glow-g)'}}><img src="/assets/play.svg" className="ic" alt="icon" /></span></a>
      </div>

      <div className="flex flex-col gap-[14px]">
    <div className="shead"><span className="text-[20px] leading-[26px] font-semibold tracking-[-0.1px] text-t1">Albums on this device</span><a className="flex flex-row items-center gap-[2px] text-[13px] leading-[16px] font-medium text-t2 flex-none no-underline" href="D05-Library.html">See all<img src="/assets/chevron_right.svg" className="ic" alt="icon" /></a></div><div className="flex flex-row items-center gap-[20px]">
      ...
      <div className="flex flex-col gap-[14px]">
    <div className="shead"><span className="text-[20px] leading-[26px] font-semibold tracking-[-0.1px] text-t1">Most played locally</span><a className="flex flex-row items-center gap-[2px] text-[13px] leading-[16px] font-medium text-t2 flex-none no-underline" href="D05-Library.html">See all<img src="/assets/chevron_right.svg" className="ic" alt="icon" /></a></div><div className="flex flex-col gap-[2px]">
    ...
    <span className="flex flex-row items-center gap-[2px] justify-end">
      <button className="ib ib-28" aria-label="Favourite Tape Hiss Lullaby"><img src="/assets/icon_94.svg" className="ic" alt="icon" /></button>
