...
<div className="flex flex-row items-center flex-grow min-w-0 overflow-hidden">
      <div className="col none w-[248px] gap-[2px]" style={{'borderRight': '1px solid var(--ln)', 'padding': '24px 12px'}}>
        ...
        <a className="sitem" href="#"><img src="/assets/icon_128.svg" className="ic" alt="icon" />Account</a><a className="sitem" href="#"><img src="/assets/music.svg" className="ic" alt="icon" />Playback</a><a className="sitem" href="#"><img src="/assets/sliders_2.svg" className="ic" alt="icon" />Audio & effects</a><a className="sitem" href="#"><img src="/assets/icon_111.svg" className="ic" alt="icon" />Library & scanning</a><a className="sitem" href="#"><img src="/assets/download_3.svg" className="ic" alt="icon" />Downloads & data</a><a className="sitem" href="#"><img src="/assets/icon_34.svg" className="ic" alt="icon" />Appearance</a><a className="sitem on" href="#"><img src="/assets/smartphone_7.svg" className="ic" alt="icon" />Connection mode</a><a className="sitem" href="#"><img src="/assets/icon_75.svg" className="ic" alt="icon" />About</a>
      </div>
      ...
      <a className="seg-i" href="D01-Home-Online.html" aria-current="false"><img src="/assets/cloud_3.svg" className="ic" alt="icon" />Online</a>
      <a className="seg-i seg-on-dev" href="D02-Home-Offline.html" aria-current="true"><img src="/assets/smartphone_8.svg" className="ic" alt="icon" />Offline</a>
    </span>
          </div>
          <span className="h-[1px] bg-ln border-0 m-0 block"></span>
          <div className="flex flex-row items-center gap-[24px]">
            <div className="flex flex-col flex-grow min-w-0 gap-[6px]">
                <span className="flex flex-row items-center gap-[8px] text-t3"><img src="/assets/smartphone_2.svg" className="ic" alt="icon" /><span className="text-[11px] leading-[14px] font-medium tracking-[0.4px]">SONGS ON DEVICE</span></span>
                ...
                <span className="flex flex-row items-center gap-[8px] text-t3"><img src="/assets/folder_4.svg" className="ic" alt="icon" /><span className="text-[11px] leading-[14px] font-medium tracking-[0.4px]">SCANNED FOLDERS</span></span>
                ...
                <span className="flex flex-row items-center gap-[8px] text-t3"><img src="/assets/download_5.svg" className="ic" alt="icon" /><span className="text-[11px] leading-[14px] font-medium tracking-[0.4px]">LOCAL STORAGE USED</span></span>
                ...
                <span className="flex flex-row items-center gap-[8px] text-t3"><img src="/assets/cloud.svg" className="ic" alt="icon" /><span className="text-[11px] leading-[14px] font-medium tracking-[0.4px]">SERVER REQUESTS TODAY</span></span>
        ...
        <div className="surf col" style={{'padding': '4px 0'}}>
          <div className="lrow" style={{'padding': '16px 20px'}}><span className="icobox"><img src="/assets/icon_40.svg" className="ic" alt="icon" /></span>
              ...
              <button className="sw on flex-none" aria-label="Stay offline until I switch back"><i></i></button></div><div className="lrow" style={{'padding': '16px 20px'}}><span className="icobox"><img src="/assets/sync_5.svg" className="ic" alt="icon" /></span>
              ...
              <button className="sw on flex-none" aria-label="Sync playlists when back online"><i></i></button></div><div className="lrow" style={{'padding': '16px 20px'}}><span className="icobox"><img src="/assets/download_3.svg" className="ic" alt="icon" /></span>
              ...
              <button className="sw on flex-none" aria-label="Auto-download favourites"><i></i></button></div><div className="lrow" style={{'padding': '16px 20px'}}><span className="icobox"><img src="/assets/cloud_7.svg" className="ic" alt="icon" /></span>
              ...
              <button className="sw flex-none" aria-label="Stream over mobile data"><i></i></button></div><div className="lrow" style={{'padding': '16px 20px'}}><span className="icobox"><img src="/assets/icon_24.svg" className="ic" alt="icon" /></span>
        ...
        <div className="flex flex-row items-center gap-[10px]">
          <a className="btn btn-out" href="D16-Folders.html"><img src="/assets/folder_2.svg" className="ic" alt="icon" />Manage music folders</a>
          <button className="btn btn-out"><img src="/assets/icon_132.svg" className="ic" alt="icon" />Clear cached artwork (1.2 GB)</button>
        </div>
      </div></div>
    </div></DesktopLayout>
    </>
