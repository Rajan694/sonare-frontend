    ...
    <div className="row between none h-[64px]" style={{'padding': '0 28px'}}>
      ...
      <span className="row g4 none" >
        <span className="row g6 none h-[26px] rounded-[999px] mr-[6px]" style={{'padding': '0 10px', 'background': 'var(--accbg)', 'color': 'var(--acc)'}}>
          <svg className="ic" width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true"><path className="" d="M7.2 18.4h9.6a4.2 4.2 0 0 0 .5-8.4A6.2 6.2 0 0 0 5.9 11a3.6 3.6 0 0 0 1.3 7.4z"/></svg><span className="t-ls" >ONLINE</span></span>
    ...
    <div className="row grow g48 items-center gap-[56px]" style={{'padding': '0 72px'}}>
      ...
      <div className="col grow gap-[22px] min-w-[0]" >
        <div className="col gap-[8px]" >
          ...
          <div className="row g10 mt-[6px]" >
            <span className="row g6 none h-[26px] rounded-[999px]" style={{'padding': '0 10px', 'background': 'var(--accbg)', 'color': 'var(--acc)'}}>
              <svg className="ic" width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true"><path className="" d="M7.2 18.4h9.6a4.2 4.2 0 0 0 .5-8.4A6.2 6.2 0 0 0 5.9 11a3.6 3.6 0 0 0 1.3 7.4z"/></svg><span className="t-ls" >STREAMING</span></span>
            <span className="t-mono-s c3" >AAC · 320 kbps · Sonare CDN</span>
          </div>
        </div>
        ...
        <div className="row g20" >
          <button className="ib ib-44" aria-label="Shuffle"><svg className="ic" width="21" height="21" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true" style={{'color': 'var(--acc)'}}><path className="" d="M16.6 3.6 20 7l-3.4 3.4"/><path className="" d="M16.6 13.6 20 17l-3.4 3.4"/><path className="" d="M3.8 7h3.4c1.7 0 2.7 1 3.7 2.4l2.7 3.9c1 1.4 2 2.4 3.7 2.4H20"/><path className="" d="M3.8 17h3.4c1.5 0 2.5-.8 3.4-2"/><path className="" d="M15.2 9c.9-1.2 1.9-2 3.4-2H20"/></svg></button>
          ...
          <button className="playbtn" aria-label="Pause" style={{'background': 'var(--acc)', 'boxShadow': 'var(--glow-s)'}}><svg className="ic" width="27" height="27" viewBox="0 0 24 24" fill="currentColor" stroke="none" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true"><rect className="" x="6.4" y="4.6" width="3.9" height="14.8" rx="1.2"/><rect className="" x="13.7" y="4.6" width="3.9" height="14.8" rx="1.2"/></svg></button>
        ...
        <div className="row g12 mt-[4px]" >
          <span className="row g10 none rounded-[12px]" style={{'padding': '10px 14px', 'background': 'rgba(17,17,20,.8)', 'border': '1px solid var(--ln2)'}}>
            <span className="" style={{'color': 'var(--acc)'}}><svg className="ic" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true"><rect className="" x="3" y="5.4" width="10.6" height="13.2" rx="2.2"/><path className="" d="M8.3 9.6v4.8"/><path className="" d="M17 9.2a4.4 4.4 0 0 1 0 5.6"/><path className="" d="M19.9 6.6a8.4 8.4 0 0 1 0 10.8"/></svg></span>
            <span className="col gap-[1px]" ><span className="t-ll c1" >Living Room Speaker</span>
            <span className="t-ls c3" >Sonare Connect</span></span>
