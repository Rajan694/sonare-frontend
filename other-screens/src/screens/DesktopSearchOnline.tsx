...
export default function DesktopSearchOnline() {
  return (
    <>
<DesktopLayout>
<div className="flex flex-row items-center flex-grow min-w-0 overflow-hidden">
      <div className="flex flex-col flex-grow min-w-0 overflow-hidden min-w-[0]"><div className="col gap-[28px]" style={{'padding': '26px 32px 0'}}>
        ...
        <div className="flex flex-row items-center gap-[24px] items-stretch">
          <div className="flex flex-col w-[400px] flex-none gap-[12px]">
            <span className="text-[11px] leading-[14px] font-semibold tracking-[0.9px] uppercase text-t3">Top result</span>
            <a className="surf col p-[20px] gap-[16px] no-underline flex-1" style={{'color': 'inherit'}} href="D06-Album.html">
              <div className="art a2 art-r-md art-rings w-[180px] h-[180px]" style={{'boxShadow': 'var(--e3)'}}></div>
          ...
          <div className="flex flex-col flex-grow min-w-0 gap-[12px] min-w-[0]">
            <span className="text-[11px] leading-[14px] font-semibold tracking-[0.9px] uppercase text-t3">Songs</span>
    ...
    <span className="flex flex-col gap-[2px] min-w-[0]">
      <span className="text-[15px] leading-[22px] font-medium text-acc truncate">Static Bloom</span>
    ...
    <div className="art a2 art-r-sm art-rings w-[40px] h-[40px]"></div>
    <span className="flex flex-col gap-[2px] min-w-[0]">
      <span className="text-[15px] leading-[22px] font-medium text-t1 truncate">Nightjar</span>
      <span className="text-[13px] leading-[18px] font-normal text-t2 truncate">Vela Nine</span>
    </span>
    <span className="text-[14px] leading-[20px] font-normal text-t2 truncate">Neon Arboretum</span>
    <span className="badge bg-cloud"><img src="/assets/cloud_6.svg" className="ic" alt="icon" />Server</span>
    ...
    <span className="flex flex-row items-center gap-[2px] justify-end">
      ...
      <button className="ib ib-28" aria-label="More options"><img src="/assets/icon_55.svg" className="ic" alt="icon" /></button>
            ...
            <div className="flex flex-row items-center gap-[24px]">
              <span className="acard justify-center items-center w-[98px]">
      <div className="art a2 art-circ art-rings w-[98px] h-[98px]"></div>
      <span className="flex flex-col justify-center items-center gap-[2px] w-[98px]">
        <span className="text-[15px] leading-[22px] font-medium text-t1 truncate max-w-[98px]">Vela Nine</span>
        <span className="text-[13px] leading-[18px] font-normal text-t3">2 albums</span>
      </span>
    </span><span className="acard justify-center items-center w-[98px]">
      <div className="art a10 art-circ art-rings w-[98px] h-[98px]"></div>
      <span className="flex flex-col justify-center items-center gap-[2px] w-[98px]">
        <span className="text-[15px] leading-[22px] font-medium text-t1 truncate max-w-[98px]">Mira Sound</span>
        <span className="text-[13px] leading-[18px] font-normal text-t3">1 albums</span>
      </span>
    </span><span className="acard justify-center items-center w-[98px]">
      <div className="art a9 art-circ art-rings w-[98px] h-[98px]"></div>
      <span className="flex flex-col justify-center items-center gap-[2px] w-[98px]">
        <span className="text-[15px] leading-[22px] font-medium text-t1 truncate max-w-[98px]">Ocean Bureau</span>
        <span className="text-[13px] leading-[18px] font-normal text-t3">1 albums</span>
      </span>
    </span><span className="acard justify-center items-center w-[98px]">
      <div className="art a11 art-circ art-rings w-[98px] h-[98px]"></div>
      <span className="flex flex-col justify-center items-center gap-[2px] w-[98px]">
        <span className="text-[15px] leading-[22px] font-medium text-t1 truncate max-w-[98px]">Dell &amp; Ray</span>
        <span className="text-[13px] leading-[18px] font-normal text-t3">3 albums</span>
      </span>
    </span>
            </div>
          </div>
