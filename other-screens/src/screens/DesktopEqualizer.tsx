...
<div className="col gap-[28px]" style={{'padding': '26px 32px 0'}}>
      <div className="flex flex-row items-center justify-between">
        ...
        <div className="flex flex-row items-center gap-[10px]">
          <button className="btn btn-out"><img src="/assets/sync_2.svg" className="ic" alt="icon" />Reset</button>
          <button className="btn btn-out"><img src="/assets/plus_2.svg" className="ic" alt="icon" />Save preset</button>
      ...
      <div className="flex flex-row items-center gap-[24px] items-start">
        ...
        <div className="flex flex-col w-[380px] flex-none gap-[16px]">
          <div className="surf col" style={{'padding': '4px 0'}}>
            <div className="lrow"><span className="icobox"><img src="/assets/sync_5.svg" className="ic" alt="icon" /></span>
                ...
                <button className="sw on flex-none" aria-label="Crossfade"><i></i></button></div><div className="lrow"><span className="icobox"><img src="/assets/music.svg" className="ic" alt="icon" /></span>
                ...
                <button className="sw on flex-none" aria-label="Gapless playback"><i></i></button></div><div className="lrow"><span className="icobox"><img src="/assets/volume_2.svg" className="ic" alt="icon" /></span>
                ...
                <button className="sw flex-none" aria-label="Volume normalization"><i></i></button></div><div className="lrow"><span className="icobox"><img src="/assets/clock_2.svg" className="ic" alt="icon" /></span>
                ...
                <img src="/assets/chevron_right_3.svg" className="ic" alt="icon" /></div>
          </div>
          <div className="bg-s1 border border-ln rounded-lg flex flex-col p-[18px] gap-[14px]">
            ...
            <div className="flex flex-row items-center gap-[12px]">
                <span className="icobox icobox-gold"><img src="/assets/headphones.svg" className="ic" alt="icon" /></span>
                ...
                <img src="/assets/icon_2.svg" className="ic" alt="icon" /></div><div className="flex flex-row items-center gap-[12px]">
                <span className="icobox"><img src="/assets/icon_79.svg" className="ic" alt="icon" /></span>
                ...
                <span className="icobox"><img src="/assets/icon_82.svg" className="ic" alt="icon" /></span>
