  ...
  <div className="qpanel">
    <div className="row between none h-[64px]" style={{'padding': '0 16px 0 20px', 'borderBottom': '1px solid var(--ln)'}}>
      ...
      <span className="flex flex-row items-center gap-[2px]">
        <button className="ib ib-32" aria-label="Shuffle queue"><img src="/assets/icon_011b35fd.svg" className="ic" alt="icon" /></button>
        <button className="ib ib-32" aria-label="Repeat"><img src="/assets/icon_30b94b7b.svg" className="ic" alt="icon" /></button>
        <a className="ib ib-32" href="D05-Library.html" aria-label="Close queue"><img src="/assets/icon_92eeb19d.svg" className="ic" alt="icon" /></a>
      </span>
    </div>
    <div className="flex flex-col p-[16px] gap-[14px] overflow-hidden">
      <div className="flex flex-row items-center gap-[8px]">
        <span className="row g6 none h-[24px] rounded-[999px]" style={{'padding': '0 9px', 'background': 'var(--accbg)', 'color': 'var(--acc)'}}>
          <img src="/assets/icon_2689920a.svg" className="ic" alt="icon" /><span className="text-[11px] leading-[14px] font-medium tracking-[0.4px]">ONLINE QUEUE</span></span>
      ...
      <div className="srow srow-on"><div className="art a1 art-r-sm art-rings w-[44px] h-[44px]"></div>
        <span className="flex flex-col flex-grow min-w-0 gap-[4px] min-w-[0]">
          <span className="flex flex-row items-center gap-[6px]"><span className="text-[13px] leading-[16px] font-medium text-acc truncate">Paper Lanterns</span><span className="src src-local" title="On this device"><img src="/assets/icon_64e34e0b.svg" className="ic" alt="icon" /></span></span>
      ...
      <div className="flex flex-col gap-[2px] overflow-hidden">
        <div className="srow" style={{'padding': '6px 8px'}}>
          <span className="drag flex-none"><img src="/assets/icon_7a2b5c8d.svg" className="ic" alt="icon" /></span>
          <div className="art a1 art-r-sm w-[36px] h-[36px]"></div>
          <span className="flex flex-col flex-grow min-w-0 gap-[1px] min-w-[0]">
            <span className="flex flex-row items-center gap-[6px]"><span className="text-[13px] leading-[16px] font-medium text-t1 truncate">Copper Wires</span><span className="src src-local" title="On this device"><img src="/assets/icon_64e34e0b.svg" className="ic" alt="icon" /></span></span>
          ...
          <button className="ib ib-28 flex-none" aria-label="Remove"><img src="/assets/icon_016ce7f0.svg" className="ic" alt="icon" /></button>
        </div><div className="srow" style={{'padding': '6px 8px'}}>
          <span className="drag flex-none"><img src="/assets/icon_7a2b5c8d.svg" className="ic" alt="icon" /></span>
          <div className="art a3 art-r-sm w-[36px] h-[36px]"></div>
          <span className="flex flex-col flex-grow min-w-0 gap-[1px] min-w-[0]">
            <span className="flex flex-row items-center gap-[6px]"><span className="text-[13px] leading-[16px] font-medium text-t1 truncate">Winter Arithmetic</span><span className="src src-local" title="On this device"><img src="/assets/icon_64e34e0b.svg" className="ic" alt="icon" /></span></span>
          ...
          <span className="flex flex-col flex-grow min-w-0 gap-[1px] min-w-[0]">
            <span className="flex flex-row items-center gap-[6px]"><span className="text-[13px] leading-[16px] font-medium text-t1 truncate">Static Bloom</span><span className="src src-cloud" title="Streaming from server"><img src="/assets/icon_964e4d72.svg" className="ic" alt="icon" /></span></span>
          ...
          <span className="flex flex-col flex-grow min-w-0 gap-[1px] min-w-[0]">
            <span className="flex flex-row items-center gap-[6px]"><span className="text-[13px] leading-[16px] font-medium text-t1 truncate">Ferrous</span><span className="src src-local" title="On this device"><img src="/assets/icon_64e34e0b.svg" className="ic" alt="icon" /></span></span>
          ...
          <span className="flex flex-col flex-grow min-w-0 gap-[1px] min-w-[0]">
            <span className="flex flex-row items-center gap-[6px]"><span className="text-[13px] leading-[16px] font-medium text-t1 truncate">Glass Houses</span><span className="src src-local" title="On this device"><img src="/assets/icon_64e34e0b.svg" className="ic" alt="icon" /></span></span>
          ...
          <span className="flex flex-col flex-grow min-w-0 gap-[1px] min-w-[0]">
            <span className="flex flex-row items-center gap-[6px]"><span className="text-[13px] leading-[16px] font-medium text-t1 truncate">Half-Light</span><span className="src src-local" title="On this device"><img src="/assets/icon_64e34e0b.svg" className="ic" alt="icon" /></span></span>
          ...
          <span className="flex flex-col flex-grow min-w-0 gap-[1px] min-w-[0]">
            <span className="flex flex-row items-center gap-[6px]"><span className="text-[13px] leading-[16px] font-medium text-t1 truncate">Low Orbit</span><span className="src src-cloud" title="Streaming from server"><img src="/assets/icon_964e4d72.svg" className="ic" alt="icon" /></span></span>
    ...
    <div className="row g8 none mt-[auto]" style={{'padding': '14px 16px', 'borderTop': '1px solid var(--ln)'}}>
      <button className="btn btn-sm btn-out flex-grow min-w-0"><img src="/assets/icon_a38dc0b5.svg" className="ic" alt="icon" />Save as playlist</button>
      <button className="btn btn-sm btn-out flex-none" aria-label="Queue options"><img src="/assets/icon_ba167e29.svg" className="ic" alt="icon" /></button>
    </div>
    </div>
    </>
    </DesktopLayout>
