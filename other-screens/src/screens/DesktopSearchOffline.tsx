...
<div className="col gap-[28px]" style={{'padding': '26px 32px 0'}}>
      <div className="flex flex-row items-center gap-[8px]">
        ...
        <span className="flex flex-row items-center gap-[8px] text-[13px] leading-[18px] font-normal text-gold"><img src="/assets/icon_cd4da788.svg" className="ic" alt="icon" />Local results only · 3 matches on this device</span>
      </div>
      ...
      <div className="offstrip"><img src="/assets/icon_2af18165.svg" className="ic" alt="icon" />
        ...
        <a className="btn btn-sm btn-out flex-none" href="D03-Search-Online.html"><img src="/assets/icon_b33441c2.svg" className="ic" alt="icon" />Search online instead</a>
      </div>
      ...
      <div className="flex flex-row items-center gap-[24px] items-start">
        <div className="flex flex-col flex-grow min-w-0 gap-[14px] min-w-[0]">
          ...
          <div className="flex flex-col gap-[2px]">
            <a className="srow no-underline" href="D16-Folders.html" style={{'color': 'inherit'}}>
              ...
              <span className="text-[13px] leading-[18px] font-normal text-t3 flex-none">842 songs · 6.1 GB</span><img src="/assets/icon_8d91587c.svg" className="ic" alt="icon" /></a><a className="srow no-underline" href="D16-Folders.html" style={{'color': 'inherit'}}>
              ...
              <span className="text-[13px] leading-[18px] font-normal text-t3 flex-none">1130 songs · 8.7 GB</span><img src="/assets/icon_8d91587c.svg" className="ic" alt="icon" /></a>
          </div>
        </div>
        <div className="flex flex-col w-[420px] flex-none gap-[14px]">
          ...
          <div className="surf row g14 p-[18px]" style={{'opacity': '.7'}}>
            <span className="icobox"><img src="/assets/icon_016d5441.svg" className="ic" alt="icon" /></span>
