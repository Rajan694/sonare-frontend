        ...
        <div className="col gap-[28px]" style={{'padding': '26px 32px 0'}}>
          <div className="flex flex-row items-center justify-between">
            ...
            <div className="flex flex-row items-center gap-[10px]">
              <button className="btn btn-out"><img src="/assets/icon_3461dc73.svg" className="ic" alt="icon" />Sync now</button>
              <a className="btn btn-acc" href="D09-Now-Playing-Online.html"><img src="/assets/icon_d6846b8b.svg" className="ic" alt="icon" />Resume</a>
            </div>
          </div>
          ...
          <div className="grid gap-[12px]" style={{'gridTemplateColumns': 'repeat(3,minmax(0,1fr))'}}>
            <a className="tile h-[64px] p-[10px] pr-[16px]" href="D06-Album.html">
              ...
              <span className="playbtn-fab flex-none w-[34px] h-[34px]"><img src="/assets/icon_6fc2fe5f.svg" className="ic" alt="icon" /></span>
            </a>
            <a className="tile h-[64px] p-[10px] pr-[16px]" href="D06-Album.html">
              <div className="art a2 art-r-sm art-rings w-[44px] h-[44px]"></div>
              <span className="flex flex-col flex-grow min-w-0 gap-[2px] min-w-[0]">
                <span className="flex flex-row items-center gap-[6px]"><span className="text-[15px] leading-[22px] font-medium text-t1 truncate">Static Bloom</span><span className="src src-cloud" title="Streaming from server"><img src="/assets/icon_964e4d72.svg" className="ic" alt="icon" /></span></span>
            ...
            <a className="tile h-[64px] p-[10px] pr-[16px]" href="D06-Album.html">
              ...
              <span className="flex flex-col flex-grow min-w-0 gap-[2px] min-w-[0]">
                <span className="flex flex-row items-center gap-[6px]"><span className="text-[15px] leading-[22px] font-medium text-t1 truncate">Undertow</span><span className="src src-cloud" title="Streaming from server"><img src="/assets/icon_964e4d72.svg" className="ic" alt="icon" /></span></span>
            ...
            <a className="tile h-[64px] p-[10px] pr-[16px]" href="D06-Album.html">
              ...
              <span className="flex flex-col flex-grow min-w-0 gap-[2px] min-w-[0]">
                <span className="flex flex-row items-center gap-[6px]"><span className="text-[15px] leading-[22px] font-medium text-t1 truncate">Low Orbit</span><span className="src src-cloud" title="Streaming from server"><img src="/assets/icon_964e4d72.svg" className="ic" alt="icon" /></span></span>
          ...
          <div className="flex flex-col gap-[14px]">
            <div className="shead"><span className="text-[20px] leading-[26px] font-semibold tracking-[-0.1px] text-t1">Made for you</span><a className="flex flex-row items-center gap-[2px] text-[13px] leading-[16px] font-medium text-t2 flex-none no-underline" href="D05-Library.html">See all<img src="/assets/icon_f7b5ebc9.svg" className="ic" alt="icon" /></a></div>
          ...
          <div className="flex flex-col gap-[14px]">
            <div className="shead"><span className="text-[20px] leading-[26px] font-semibold tracking-[-0.1px] text-t1">Trending on Sonare</span><a className="flex flex-row items-center gap-[2px] text-[13px] leading-[16px] font-medium text-t2 flex-none no-underline" href="D03-Search-Online.html">See all<img src="/assets/icon_f7b5ebc9.svg" className="ic" alt="icon" /></a></div>
            <div className="flex flex-col gap-[2px]">
              ...
              <div className="grid gap-[16px] items-center rounded-[10px]" style={{'gridTemplateColumns': '30px 44px minmax(0,2.4fr) minmax(0,1.7fr) 116px 64px 58px 78px', 'padding': '7px 12px'}}>
                ...
                <span className="flex flex-row items-center gap-[2px] justify-end">
                  <button className="ib ib-28" aria-label="Favourite Low Orbit"><img src="/assets/icon_40ab73e4.svg" className="ic" alt="icon" /></button>
                  <button className="ib ib-28" aria-label="More options"><img src="/assets/icon_5393a18d.svg" className="ic" alt="icon" /></button>
                </span>
              </div>
              <div className="grid gap-[16px] items-center rounded-[10px]" style={{'gridTemplateColumns': '30px 44px minmax(0,2.4fr) minmax(0,1.7fr) 116px 64px 58px 78px', 'padding': '7px 12px'}}>
