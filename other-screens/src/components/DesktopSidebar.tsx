...
<div className="row g10" style={{'height': '64px', 'padding': '0 18px', 'flex': 'none', 'borderBottom': '1px solid var(--ln)'}}>
  <span className="row center none" style={{'width': '28px', 'height': '28px', 'borderRadius': '9px', 'background': 'var(--acc)', 'color': '#000'}}><img src="/assets/music_3.svg" className="ic" alt="icon" /></span>
  <span className="col grow" style={{'gap': '0'}}>
    <span className="t-tl c1" style={{'letterSpacing': '-.3px'}}>Sonare</span>
  </span>
  <button className="ib ib-28 flex-none" aria-label="Collapse sidebar"><img src="/assets/maximize.svg" className="ic" alt="icon" /></button>
</div>
<div className="col" style={{'padding': '12px 10px', 'gap': '2px', 'flex': 'none'}}>
  <a className="sitem on" href="D01-Home-Online.html"><img src="/assets/home.svg" className="ic" alt="icon" />Home</a><a className="sitem" href="D03-Search-Online.html"><img src="/assets/icon_14.svg" className="ic" alt="icon" />Search</a><a className="sitem" href="D05-Library.html"><img src="/assets/library.svg" className="ic" alt="icon" />Your Library</a><a className="sitem" href="D08-Playlist.html"><img src="/assets/playlist.svg" className="ic" alt="icon" />Playlists</a>
</div>
...
<div className="col" style={{'padding': '12px 10px 6px', 'gap': '2px', 'flex': 'none'}}>
  ...
  <a className="sitem" href="D05-Library.html"><img src="/assets/music_2.svg" className="ic" alt="icon" />Songs</a><a className="sitem" href="D05-Library.html"><img src="/assets/disc.svg" className="ic" alt="icon" />Albums</a><a className="sitem" href="D05-Library.html"><img src="/assets/mic.svg" className="ic" alt="icon" />Artists</a><a className="sitem" href="D05-Library.html"><img src="/assets/grid.svg" className="ic" alt="icon" />Genres</a><a className="sitem" href="D16-Folders.html"><img src="/assets/folder_3.svg" className="ic" alt="icon" />Folders</a>
</div>
<span className="hr" style={{'margin': '4px 16px'}}></span>
<div className="col grow" style={{'padding': '12px 10px', 'gap': '2px', 'overflow': 'hidden'}}>
  <div className="row between" style={{'padding': '0 12px 8px'}}>
    ...
    <button className="ib ib-28 flex-none" aria-label="New playlist"><img src="/assets/plus_3.svg" className="ic" alt="icon" /></button>
  </div>
  <a className="sitem " href="D08-Playlist.html" style={{'height': '44px'}}>
    ...
    <span className="none" style={{'color': 'var(--gold)'}}><img src="/assets/smartphone.svg" className="ic" alt="icon" /></span>
    ...
    <span className="none" style={{'color': 'var(--blue)'}}><img src="/assets/sync_6.svg" className="ic" alt="icon" /></span>
  </a><a className="sitem " href="D08-Playlist.html" style={{'height': '44px'}}>
    ...
    <span className="none" style={{'color': 'var(--acc)'}}><img src="/assets/cloud_4.svg" className="ic" alt="icon" /></span>
  </a><a className="sitem " href="D08-Playlist.html" style={{'height': '44px'}}>
